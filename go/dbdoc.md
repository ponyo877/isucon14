...
graph LR
  ...
  func:github.com/isucon/isucon14/webapp/go.appGetNearbyChairs[appGetNearbyChairs]:::func --> table:xxxxx[xxxxx]:::table
  linkStyle 0,1,2,3,6,7,13,14,16,19,21,23,24,25,26,27,31,33,36,38,40,41,42,45,46,47,49,52,55,56,58,61,62,63,64,67,69,70,71,72 stroke:#78909C,stroke-width:2px
  linkStyle 4,10,11,12,17,18,28,29,43,44,50,51,59,68 stroke:#BBDEFB,stroke-width:2px
  linkStyle 5,8,9,20,35,37,39,53,54,65,66 stroke:#CDDC39,stroke-width:2px
  linkStyle 15,22,30,32,34,48,57,60 stroke:#FF9800,stroke-width:2px
```